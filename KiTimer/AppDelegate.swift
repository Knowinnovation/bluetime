...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UserSettings.sharedSettings().lastDuration = NSUserDefaults.standardUserDefaults().doubleForKey("last_duration")
        return true
    }
    ...
    func applicationDidEnterBackground(application: UIApplication) {
        ...
        NSUserDefaults.standardUserDefaults().setDouble(UserSettings.sharedSettings().lastDuration, forKey: "last_duration")
    }
